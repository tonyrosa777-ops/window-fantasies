...
export default function PortfolioPage() {
  ...
  return (
    <>
      ...
      <Section tone="base" bgImage="/images/headers/portfolio.webp" bgImageAlt="A luxury living room with golden light through sheer shades." className="pt-32 sm:pt-36 lg:pt-40">
        <Container>
          <FadeUp>
