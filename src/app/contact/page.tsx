...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/* 1. Page Header */}
      <Section tone="base" bgImage="/images/headers/contact.webp" bgImageAlt="A welcoming sunroom entry with light through plantation shutters." className="pt-32 sm:pt-36 lg:pt-40">
        <Container>
          <FadeUp>
