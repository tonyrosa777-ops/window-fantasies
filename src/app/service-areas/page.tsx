...
export default function ServiceAreasIndexPage() {
  ...
  return (
    <>
      {/* 1. Hero / Page header */}
      <Section tone="base" bgImage="/images/headers/service-areas.webp" bgImageAlt="A classic New England neighborhood in early autumn at golden hour." className="pt-32 sm:pt-36 lg:pt-40">
        <Container>
          <FadeUp>
