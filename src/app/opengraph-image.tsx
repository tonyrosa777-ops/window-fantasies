 ...
 *
 * ⚠️ COMPLIANCE: this card is advertising creative bearing the Hunter Douglas
 * name, so HD requires it carry a dated copyright and trademark attribution
 * line. It is rendered from hdCopyrightLine() in src/data/hunterDouglas.ts, the
 * same source the site footer uses, so the two can never drift apart. Do not
 * retype the sentence here and do not drop the line to reclaim layout space.
 */
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <span>Authorized Hunter Douglas Dealer</span>
        ...
        {/* Sign-off block: dealer identity row, then HD's required attribution. */}
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          {/* HD-required dated copyright + trademark attribution. */}
          <div
            style={{
              display: "flex",
              fontSize: "15px",
